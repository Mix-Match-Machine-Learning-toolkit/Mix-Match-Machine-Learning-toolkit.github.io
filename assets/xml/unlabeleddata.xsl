...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
              ...
              <div class='divToken'>
                <img>
                  ...
                  <xsl:attribute name="src">
                    <xsl:value-of select="data/unlabeledimage"/>
                  </xsl:attribute>
                </img>
                <img>
                  ...
                  <xsl:attribute name="src">
                    <xsl:value-of select="data/datatoken[ultoken=$tokenselected]/image"/>
                  </xsl:attribute>
                </img>
                <div class="imageTextCenter">
                <p class='overlaptext'>
                  <xsl:value-of select="data/datatoken[ultoken=$tokenselected]/datatype"/>
                </p>
 ...
 data</h3>
        ...
        <div class='centerBlock'>
          ...
          <p>
            <i class="fa-solid fa-triangle-exclamation fa-lg unlabeled">&#160;
            </i>
